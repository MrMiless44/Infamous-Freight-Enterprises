      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-10">
          {article.sections.map((section) => (
            <section key={section.heading}>
              <h2 className="text-xl font-bold text-[#F5E8E8]">{section.heading}</h2>
              <p className="mt-3 text-base leading-8 text-[#F5E8E8]/80">{section.body}</p>
            </section>
          ))}
        </div>
        ...
        {article.relatedLinks.length > 0 && (
          <nav className="mt-12 rounded-2xl border border-infamous-border bg-infamous-card p-6">
            <h2 className="text-lg font-bold text-[#F5E8E8]">Related</h2>
        ...
        <section className="mt-12 rounded-2xl border border-infamous-border bg-[#0f0f0f] p-8">
          ...
          <p className="mt-2 text-sm leading-6 text-[#B88989]">
            ...
            {resourceArticles
              ...
              .map((a) => (
                ...
                >
                  ...
                  <h3 className="mt-2 font-bold text-[#F5E8E8]">{a.title}</h3>
                  <p className="mt-2 text-sm leading-6 text-[#B88989]">{a.description}</p>
                </Link>
              ))}
          </div>
        </section>
