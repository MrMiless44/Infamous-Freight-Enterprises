      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-10 max-w-3xl">
          ...
          <p className="mt-4 text-lg leading-8 text-gray-300">
            From small freight to regional lanes, Infamous Freight connects quote intake, dispatch, tracking, and proof of delivery in one workflow.
          </p>
        </header>
        ...
        <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {servicePages.map((service) => (
            <Link
              ...
              className="group flex h-full flex-col rounded-3xl border border-infamous-border bg-infamous-card p-6 transition hover:border-infamous-orange/50"
            >
              <div className="mb-4 inline-flex w-fit rounded-xl bg-infamous-orange/10 p-3 text-infamous-orange">
                {service.icon}
              </div>
              ...
              <span className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-infamous-orange">
          ...
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              {[
                ...
                <div key={item} className="flex gap-3 rounded-2xl border border-infamous-border bg-infamous-card p-4">
