    ...
    <main className="min-h-screen bg-[#090909] px-6 py-16 text-white">
      <section className="mx-auto max-w-3xl rounded-3xl border border-infamous-border bg-infamous-card p-8 shadow-2xl">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <Link to="/" className="inline-flex items-center justify-center gap-2 rounded-xl bg-infamous-orange px-5 py-3 font-semibold text-white transition hover:opacity-90">
            Back to home <ArrowRight size={17} />
          </Link>
          <Link to="/contact" className="inline-flex items-center justify-center rounded-xl border border-infamous-border bg-[#111] px-5 py-3 font-semibold text-white transition hover:border-infamous-orange/60">
            Contact support
          </Link>
        </div>
      </section>
